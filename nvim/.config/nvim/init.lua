...
vim.keymap.set('n', '<M-x>', require('telescope.builtin').commands, { desc = 'Search Diagnostics' })
vim.keymap.set('n', '<leader>pp', require('telescope').extensions.projects.projects, { desc = 'Search Diagnostics' })
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>cf', vim.lsp.buf.format, '[W]orkspace [R]emove Folder')
